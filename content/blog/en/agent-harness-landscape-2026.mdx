...
This comparison reflects public documentation as of 2026-07. Pricing, plan boundaries, limits, model availability, and beta features change quickly; verify the primary sources before making an adoption decision.
...
## Reproducibility Note (2026-07 Snapshot)
...
- OpenAI Codex permissions: [Codex permissions](https://developers.openai.com/codex/permissions)
- OpenAI Codex hooks: [Codex hooks](https://developers.openai.com/codex/hooks)
- OpenAI Codex MCP: [Codex MCP](https://developers.openai.com/codex/mcp)
- OpenAI Codex subagents: [Codex subagents](https://developers.openai.com/codex/subagents)
